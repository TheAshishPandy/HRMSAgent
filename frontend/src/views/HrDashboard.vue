<template>
  <div>
    ...
    <p style="margin-top:24px"><router-link to="/hr/attendance">Attendance</router-link> · <router-link to="/hr/leave">Leave</router-link> · <router-link to="/hr/employees">People directory</router-link> · <router-link to="/hr/jobs/new">Create a job</router-link></p>
  </div>
</template>
<script>
import { api } from "../api";
