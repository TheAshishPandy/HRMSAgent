<template>
  <div>
    ...
    <div class="grid cols-4">
      ...
      <div class="card stat"><div class="muted">Unread mail</div><div class="n">{{ d.unread }}</div></div>
    </div>
    <p style="margin-top:24px"><router-link to="/hr/jobs/new">Create a job</router-link></p>
  </div>
</template>
<script>
import { api } from "../api";
export default {
  data: () => ({ d: { open_jobs: 0, pipeline: {}, upcoming_interviews: 0, unread: 0 } }),
  async created() {
