...
const routes = [
  ...
  { path: "/hr/onboarding", name: "hr-onboarding", component: () => import("./views/OnboardingView.vue"), meta: { role: "hr" } },
  ...
  { path: "/work/onboarding", name: "work-onboarding", component: () => import("./views/OnboardingView.vue"), meta: { role: "employee" } },
  { path: "/work/inbox", name: "work-inbox", component: () => import("./views/InboxView.vue"), meta: { role: "employee" } },
